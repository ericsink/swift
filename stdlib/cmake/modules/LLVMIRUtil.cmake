...
function(llvmir_attach_bc_target)
  ...
  list(FILTER IN_FILES EXCLUDE REGEX "\\.h$")
  ...
  # TODO the following should probably be done by the function just called
  string(REPLACE "\ " ";" IN_COMPILE_FLAGS ${IN_COMPILE_FLAGS})
  ...
  foreach(IN_FILE ${IN_FILES})
    ...
    llvmir_extract_compile_flags(IN_FILE_COMPILE_FLAGS ${IN_FILE})
    ...
    string(REPLACE "$<COMPILE_LANGUAGE:C>" "1" CMD_ARGS "${CMD_ARGS}")
    string(REPLACE "$<COMPILE_LANGUAGE:CXX>" "1" CMD_ARGS "${CMD_ARGS}")
...
function(llvmir_attach_link_target)
  ...
  add_custom_command(OUTPUT ${FULL_OUT_LLVMIR_FILE}
    ...
    COMMENT "Linking LLVM bitcode ${FULL_OUT_LLVMIR_FILE}"
    VERBATIM)
